# App Store theme, by Ubuntu Web

This theme has been written specifically for Ubuntu Web, based on Hyde.

# Original Hyde README (may be incorrect in many ways, for the App Store theme)
